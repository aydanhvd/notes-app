...
export const EditeArchiveForm = ({ note, color }) => {
	const { arcveBtn } = useContext(NotesContext);
	...
	return (
		<Container>
			<Form onSubmit={onSubmit}>
				...
				<Textarea type="text" name="text" value={data.text} onChange={onChange} />
